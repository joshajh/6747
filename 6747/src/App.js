...
function App() {
    ...
    return (
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        ...
        <p>The full recording of 6,749 names is 5 hours, 29 minutes, and 4 seconds in duration, and can be heard in its entirety by calling 0203 835 3250 from any phone. The first 20 minutes is available on this page.</p>
